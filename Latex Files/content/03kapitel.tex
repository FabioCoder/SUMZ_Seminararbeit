...
\comment{Evtl. Beschreibung eines Editors.} 
...
\comment{Kurz auf das Entwurfsmuster Decorator eingehen. Wird bei Komponenten, Services, Modulen, etc. verwendet}
\section{Konzepte}
