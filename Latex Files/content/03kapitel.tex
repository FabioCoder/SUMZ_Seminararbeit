...
Im Folgenden werden die in Angular verwendeten Konzepte näher erläutert. Die Beispielanwendung in \autoref{fig:AngularAnwendung} wird zur Erklärung der Konzepte verwendet. Eine Änderung des Namens im Input-Feld bewirkt eine Veränderung des Namens in der Überschrift.
...
Eine Angular-Anwendung kann aus mehreren Angular-Modulen bestehen und ist demnach modular aufgebaut. Angular-Module sind nicht mit den in \autoref{sec:der-sprachstandard-ecmascript} vorgestellten JavaScript-Modulen zu verwechseln. \autocites[vgl.][103\psqq]{Steyer.2017}[vgl.][301\psqq]{Woiwode.2018} Die Module einer Angular-Anwendung können in Root-Module, Feature-Module und Shared-Module unterteilt werden. 
%%Bootstrapping
